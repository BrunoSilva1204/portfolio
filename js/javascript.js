function calcular_etiquetas(){
    ...
    var vias_usadas = document.getElementById('vias_usadas').value; //vias que o operador pode usar consuante a largura da bobine
    ...
    if(rolos_feitos_por_acao < 1 || vias_usadas>vias_cortante){
        alert("Impossivel vias do cortante não são as suficientes");
    }else{
        ...
        if(numero_acoes == 1){
            ...
            //200 por rolo
            //vias 6
            var quantidade_por_rolo_incompleto = Math.trunc(total_etiquetas/rolos_feitos_por_acao)+1;
